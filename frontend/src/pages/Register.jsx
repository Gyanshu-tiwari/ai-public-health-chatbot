    ...
    <div className="min-h-screen bg-[#0B0C10] flex items-center justify-center p-6 relative overflow-hidden font-sans selection:bg-indigo-500/30">
      ...
      >
        ...
        <div className="bg-white/[0.03] backdrop-blur-xl border border-white/10 rounded-[2.5rem] p-8 md:p-10 shadow-2xl shadow-black/50">
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-xs uppercase tracking-[0.2em] font-bold">
              <span className="bg-[#121318] px-4 text-slate-500">
                Or join with
              </span>
            </div>
          </div>
          ...
          <button className="w-full flex items-center justify-center gap-3 bg-white/5 border border-white/10 hover:bg-white/10 hover:border-white/20 py-4 rounded-2xl transition-all group">
            <div className="p-1 bg-white rounded-md shadow-sm">
              <svg className="w-4 h-4" viewBox="0 0 24 24">
                <path
                  fill="#EA4335"
                  d="M24 12.27c0-.85-.07-1.66-.21-2.46H12v4.65h6.72c-.29 1.56-1.17 2.89-2.48 3.78v3.13h4.02c2.35-2.17 3.71-5.36 3.71-9.1z"
                />
                <path
                  fill="#4285F4"
                  d="M12 24c3.24 0 5.95-1.08 7.93-2.91l-4.02-3.13c-1.11.75-2.53 1.19-3.91 1.19-3.01 0-5.56-2.03-6.47-4.76H1.4v3.13C3.38 21.6 7.42 24 12 24z"
                />
                <path
                  fill="#FBBC05"
                  d="M5.53 14.39c-.24-.72-.37-1.48-.37-2.39s.13-1.67.37-2.39V6.48H1.4c-.88 1.76-1.4 3.74-1.4 5.52 0 1.78.52 3.76 1.4 5.52l4.13-3.13z"
                />
                <path
                  fill="#34A853"
                  d="M12 4.75c1.77 0 3.35.61 4.6 1.8l3.45-3.45C17.96 1.07 15.24 0 12 0 7.42 0 3.38 2.4 1.4 6.48l4.13 3.13c.91-2.73 3.46-4.76 6.47-4.76z"
                />
              </svg>
            </div>
        ...
        <p className="text-left mt-8 px-2 text-slate-500 text-sm font-medium">
          ...
          <Link
            to="/login"
            className="text-white font-bold hover:text-indigo-400 transition-colors underline-offset-4 hover:underline"
          >
            Sign in
          </Link>
        </p>
